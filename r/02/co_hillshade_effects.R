...
coch <- st_read("/home/yoviajo/Documentos/lab/geom/r/97/geodat/lim_dpto_cochabamba.shp")
plot(coch)
...
a <- setMinMax(mdt2)
# dpto. de Cochabamba, mín = 1 msnm, máx 6755 msnm
a
...
# reproject vect
coch <- st_transform(coch, "+proj=utm +zone=20 +south +datum=WGS84 +units=m +no_defs")

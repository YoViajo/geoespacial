...
scru <- st_read("/home/yoviajo/Documentos/lab/geom/r/97/geodat/lim_dpto_santacruz.shp")
plot(scru)
...
a <- setMinMax(mdt2)
# dpto. de Santa Cruz, mín = 0 msnm, máx 4736 msnm
a
...
# reproject
mdt <- project(mdt, "+proj=lcc +lat_1=-15.5 +lat_2=-19 +lat_0=-22 +lon_0=-61 +x_0=1000000 +y_0=0 +datum=WGS84 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs")

# reproject vect
scru <- st_transform(scru, "+proj=lcc +lat_1=-15.5 +lat_2=-19 +lat_0=-22 +lon_0=-61 +x_0=1000000 +y_0=0 +datum=WGS84 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs")

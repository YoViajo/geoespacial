...
boli <- st_read("/home/yoviajo/Documentos/lab/geom/r/97/geodat/lim_Bolivia.shp")
plot(boli)
...
a <- setMinMax(mdt2)
# Bolivia, mín = 0 msnm, máx 7360 msnm (algo está mal en el valor máx)
a
...
# reproject
mdt <- project(mdt, "+proj=lcc +lat_1=-11.5 +lat_2=-21.5 +lat_0=-24 +lon_0=-64 +x_0=1000000 +y_0=0 +datum=WGS84 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs")

# reproject vect
boli <- st_transform(boli, "+proj=lcc +lat_1=-11.5 +lat_2=-21.5 +lat_0=-24 +lon_0=-64 +x_0=1000000 +y_0=0 +datum=WGS84 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs")

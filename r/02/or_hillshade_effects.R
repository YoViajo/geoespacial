...
orur <- st_read("/home/yoviajo/Documentos/lab/geom/r/97/geodat/lim_dpto_oruro.shp")
plot(orur)
...
a <- setMinMax(mdt2)
# dpto. de Oruro, mín = 1746 msnm, máx 6553 msnm
a
...
# reproject
mdt <- project(mdt, "+proj=utm +zone=19 +south +datum=WGS84 +units=m +no_defs")

# reproject vect
orur <- st_transform(orur, "+proj=utm +zone=19 +south +datum=WGS84 +units=m +no_defs")

...
chuq <- st_read("/home/yoviajo/Documentos/lab/geom/r/97/geodat/lim_dpto_chuquisaca.shp")
plot(chuq)
...
a <- setMinMax(mdt2)
# dpto. de Chuquisaca, mín = 56 msnm, máx 5020 msnm
a
...
# reproject vect
chuq <- st_transform(chuq, "+proj=utm +zone=20 +south +datum=WGS84 +units=m +no_defs")
